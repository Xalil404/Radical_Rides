...
from .views import all_products, product_detail, view_wishlists, view_wishlist, wishlist_add, create_wishlist, select_products, delete_wishlist, remove_from_wishlist
